                                        ...
                                        <div class="grid grid-cols-3 gap-3">
                                            <div class="sm:col-span-3">
                                                ...
                                                <div class="mt-1">
                                                    <input type="text" name="name" id="name"
                                                        wire:model="product.name" placeholder="insert product name"
                                            ...
                                            <div class="sm:col-span-2">
                                                ...
                                                <div class="mt-1">
                                                    <input type="number" name="price" id="price"
                                                        wire:model="product.price" placeholder="insert product price"
                                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                    @error('product.price')
                                                        <small class="text-red-600">{{ $message }}</small>
                                                    @enderror
                                            ...
                                            <div class="sm:col-span-1">
                                                ...
                                                <div class="mt-1">
                                                    <input type="number" name="stock" id="stock"
                                                        wire:model="product.stock" placeholder="insert product stock"
                                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                    @error('product.stock')
                                                        <small class="text-red-600">{{ $message }}</small>
                                                    @enderror
                                            ...
                                            <div class="sm:col-span-3">
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    <textarea name="description" name="description" id="description" wire:model="product.description" cols="30"
                                                        rows="10" placeholder="insert product description"
